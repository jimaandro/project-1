...
HD_PWD='/home/dimitriosa/Downloads/Project/project_1/project_1.runs/design_1_ALUdesign_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_ALUdesign_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_ALUdesign_1_0.tcl
