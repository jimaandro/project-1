...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ALUdesign is
  ...
  signal outnum_axis_tready_REG_i_1_n_0 : STD_LOGIC;
  signal outnum_axis_tready_REG_reg_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of outnum_axis_tready_REG_i_1 : label is "soft_lutpair14";
...
outnum_axis_tready_REG_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
      ...
      I1 => rst,
      O => outnum_axis_tready_REG_i_1_n_0
    );
outnum_axis_tready_REG_reg: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => '1',
      D => outnum_axis_tready_REG_i_1_n_0,
      Q => outnum_axis_tready_REG_reg_n_0,
      R => '0'
    );
outnum_axis_tvalid_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"BB8B"
    )
        port map (
      I0 => \^outnum_axis_tvalid_reg_0\,
      I1 => rst,
      I2 => outnum_axis_tready_REG_reg_n_0,
      I3 => outnum_axis_tready,
